...
int verificareButoaneJoystick()
{
    ...
    if (butonJoystick1 == LOW && butonJoystick2 == LOW)
        return 3;
    if (butonJoystick1 == LOW)
        return 1;
    if (butonJoystick2 == LOW)
        return 2;
...
{
    if (verificareButoaneJoystick() == 1 || verificareButoaneJoystick() == 3)
        modelMatriceJ1();
    else
        resetJumatate1Matrice();

    if (verificareButoaneJoystick() == 2 || verificareButoaneJoystick() == 3)
        modelMatriceJ2();
    else
        resetJumatate2Matrice();

    if (verificareButoaneJoystick() == 3)
        stareJoc = JOCUL_INCEPE_RULAREA; //jocul va incepe daca ambele butoane sunt apasate simultan
...
void schimbareModelMatrice()//pe matrice va fi afisata o numaratoare inversa pana la inceperea jocului
{
    ...
    case 0:
        resetMatrice();
        contorModelMatrice++;
        if (contorModelMatrice < 2)
            modelMatrice = 1;
        if (contorModelMatrice == 2)
            modelMatrice = 2;
        if (contorModelMatrice == 3)
            modelMatrice = 3;
        if (contorModelMatrice == 4)
            modelMatrice = 4;
...
void citireJS()
{
    ...
    if (pozitieJoystick1X < 300)
        miscareStanga(1);
    else if (pozitieJoystick1X > 700)
        miscareDreapta(1);

    if (pozitieJoystick2X < 300)
        miscareStanga(2);
    else if (pozitieJoystick2X > 700)
        miscareDreapta(2);
}
...
void afisareMesajLCDInJoc()
{
    ...
    lcd.setCursor(0,0);
    if (viataJucator1 == 2)
        lcd.print("J1: 2 vieti");
    else
        lcd.print("J1: o viata");

    lcd.setCursor(0,1);
    if (viataJucator2 == 2)
        lcd.print("J2: 2 vieti");
    else
        lcd.print("J2: o viata");
}
...
void miscareProiectil()
{
    if (proiectil1X > 0 && proiectil1X < 7)
    {
        ...
        if (proiectil1X != 2)
            matriceLed[proiectil1X - 1][proiectil1Y] = 0;
    ...
    if (proiectil2X < 7 && proiectil2X > 0)
    {
        ...
        if(proiectil2X != 5)
            matriceLed[proiectil2X + 1][proiectil2Y] = 0;
